import { Heart, BrainCircuit, ShieldCheck } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 w-full">
        ...
        <section className="mb-20">
          <h2 className="text-2xl font-bold text-primary mb-6 flex items-center gap-3">
            <BrainCircuit className="w-6 h-6" /> The Silent Crisis
          </h2>
          <div className="bg-card border border-border p-6 md:p-8 rounded-2xl space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
              ...
              <div className="bg-background p-4 rounded-xl border border-border">
                ...
                <p className="text-muted-foreground text-sm">the time when most students feel the most isolated and overwhelmed.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-20">
          <h2 className="text-2xl font-bold text-secondary mb-6 flex items-center gap-3">
            <Heart className="w-6 h-6" /> Our Vision
          </h2>
          <div className="space-y-6 text-white/90 text-lg leading-relaxed">
            <p>Saathi was built to bridge this gap. We are a voice-first AI companion trained specifically on the emotional context of Indian students.</p>
            <p>We believe talking is healing. Typing out a panic attack is hard, but speaking to a calm, non-judgmental voice can interrupt the cycle of anxiety. Saathi isn't just a chatbot; it's a multi-agent system designed to act as an empathetic listener, a study strategist, and a reality checker.</p>
          </div>
        </section>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-white/80">
                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary" /><strong>Samagra Shikshana Karnataka:</strong> Supporting holistic student well-being.</li>
                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary" /><strong>DIKSHA Integration:</strong> Providing emotional support alongside digital learning.</li>
                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary" /><strong>Goal 2025:</strong> Reaching 500+ schools across Karnataka to provide free access.</li>
                  </ul>
                </div>
              </div>
            </CardContent>
